...
public class Main {
    public static void main(String[] args) throws InterruptedException, IOException
    {
        ...
        TimeUnit.SECONDS.sleep(2);
        System.out.println("It's time to face my fears...\n");
        TimeUnit.SECONDS.sleep(2);
        // end of chapter 8
        // start of chapter 9
        System.out.println("Chapter 9: Lost souls\n");
        TimeUnit.SECONDS.sleep(5);
        System.out.println("Evil Mage: Hey, you there!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\nIs someone calling for me?\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: If you want to keep going, you have to fight me!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": ...Really?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Can't we just talk this out?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Huh...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: No one has ever asked me that before...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Sooo, no fight?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: ...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: I'm in the mood to fight someone!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\nAre you serious right now...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Fine, let's fight...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Heh, whoever wins is the champion of this mountain!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Sure...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\nFirst it was rats, now this random old man...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(The old man raises his fists...)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": If it's a fight you want old man, so be it...");
        TimeUnit.SECONDS.sleep(2);
        // second battle here
        Monster oldMan = new Monster("Old Man", 20, "Old hands", 2);
        while (battleActive)
        {
            TimeUnit.SECONDS.sleep(2);
            oldMan.printOldManMonster();
            ...
            if(userSelect == 1)
            {
                int weaponDamage = (int)((Math.random() * 10) + 1);
                TimeUnit.SECONDS.sleep(2);
                System.out.println(mainName + " attacked " + oldMan.getName() + " with a " + heroWeapon + " for " + weaponDamage + " damage!");
                oldMan.setHealth(weaponDamage);
                if(oldMan.getHealth() <= 0)
                {
                    protagonist.setLevel(2);
                    break;
                }
            ...
            {
                TimeUnit.SECONDS.sleep(2);
                System.out.println(mainName + " gets into a guard position.");
            }
            if(userSelect == 3)
            {
                TimeUnit.SECONDS.sleep(2);
                System.out.println("Are you really going to leave your friends behind?");
            }
            else
            {
                TimeUnit.SECONDS.sleep(2);
            ...
            System.out.println(oldMan.getName() + " attacks using " + oldMan.getAttack() + ", it does no damage? (He's old that why...)");
        }

        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Guess I'm getting too old for this fighting thing...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\nYou can say that again.\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": You tried your best old man.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Eh, it's okay. I need to go back home.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Alright, see you around I guess?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Bye!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": ...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Hold on...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: I have something to give you.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Huh? For me?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Are you sure?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Yeah, you are " + mainName + " are you not?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Yeah... how do you know my name?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Word spreads around kiddo, nothing to it.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: Anyways, here you are.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\n(The old man gives " + mainName + " a necklace.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": What is this?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Old Man: You'll find out soon enough. See you.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\n(The old man disappears)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Hey! Where did you go?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\nI guess I'll hold on to this...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Alright! Time to head to the top!\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Sun and Moon... I'm coming to get you.\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Even if it means risking something...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Lets go!\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You keep going up, holding on tight to the necklace.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You feel a fire in your heart.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You have the strength to keep going!)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You feel close to the top...)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You suddenly have a burst of confidence.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You feel like you can do anything!)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + "Moon? Sun? It's me " + mainName + "! Are you here?\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I need you guys...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Come back home...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\n...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You hear a familar voice...)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Holy Cat???");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Hello, " + mainName + ".");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I'm glad to see you're doing...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Okay... I believe.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Anyways, I sense people nearby.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": You do?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I hope it's who I think it is...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Wait...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": How can you sense people?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Blessings are very powerful.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: You'll understand one day...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: That necklace...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Where did you get it from?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Some old man gave it to me...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Oh yeah...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I beat up an old man!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: ...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Well, that necklace has special powers.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Woah! Really?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Yeah.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: But before you do something, or anything with it...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: You must leave something precious behind before you use the necklace.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Oh...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I guess I'll only use it when I need to.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\nWow! This is cool but lame at the same time...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Oh well...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("I hope I don't need to use this...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: So, chosen one, you understand?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Well...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Sorta.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I'll explain it more clearly.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: This necklace isn't a toy.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: You have to give up something important, to gain something.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: If you think it's worth it, go ahead.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: But...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Once you do that...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: There's no way to reverse it.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: So...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Think real hard about what you're doing.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Think about the consequences...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Once again...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Make sure that you're doing the right thing.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I'll make sure to check everything Holy Cat.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I won't mess up!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I promise...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: ...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I believe in you, " + mainName);
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I'll see you soon.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Bye Holy Cat...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Don't do anything rash chosen one.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I won't!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Good.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\n(Holy Cat disappears.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("So, this necklace...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("I really should throw this away...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("No one should have to disappear because of this...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("I should give it back to the old man once I'm done here.\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("So much is happening...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("After this is over...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("I'll have a nice and long nap...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Anyways...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("I need to get back to work..!\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Here I come!\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You continue to move forward.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You feel so close.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("(You have nothing to lose.)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Helloooo?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Anyone there?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Say something...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": ...");
        ...
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Is that a cave?\n");
        TimeUnit.SECONDS.sleep(2);
        // end of chapter 9
        // start of chapter 10
        System.out.println("Chapter 10: The dark\n");
        TimeUnit.SECONDS.sleep(5);
        System.out.println("...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Should I explore more?\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("...\n");
        TimeUnit.SECONDS.sleep(2);
        ...
        TimeUnit.SECONDS.sleep(2);
        System.out.println("I have decided to...\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("1. Go in...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("2. Go back...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("3. Summon Holy Cat.");
        TimeUnit.SECONDS.sleep(2);
        // cave choice
        ...
        {
            TimeUnit.SECONDS.sleep(2);
            System.out.println("\n" + mainName + ": Holy Cat? Where are you?\n");
            TimeUnit.SECONDS.sleep(2);
        ...
        {
            TimeUnit.SECONDS.sleep(2);
            System.out.println(mainName + ": Meh.");
        }
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": This sucks...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Alright, I've made up my mind.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I'm going to...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: " + mainName + ", there's no point in going in that cave.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Your friends aren't there.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": What..?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": How do you know that Holy Cat?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I'm able to see everything within a 10 mile radius.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": You... can?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Wait a minute...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": If you could do this the whole time...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Why didn't you tell me before I went up..?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Well.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Everything you do is for a reason.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Remember what your goal is.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Get stronger.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: You needed to train, right?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I need to get stronger.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I also need to train.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": So, this whole time...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": You were testing me?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Yes, this was a test.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: It was designed to help with your training.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I would say you passed.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": That's great and all...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": But what about the necklace?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Yes, the necklace...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: That was a gift from me.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": What? A gift?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": From what you told me...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": It sounds like a curse...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I hid the truth of the necklace away from you.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: The necklace grants you temporary powers.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Temporary?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": What do you mean?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: You can only have the powers for about 1 battle.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Don't worry, the necklace should regenerate during your next battle.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": That sounds great!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Any side effects or downsides?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: The only downside is that you'll feel more tired than usual.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Oh, alright. That's not bad.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": We are so high up...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I really don't feel like walking back down...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Okay then, close your eyes...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: I'll send you back to the village.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": You can do that?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": That's so cool!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Yeah, I'll talk about it more later.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Alright, close your eyes...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Alright...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("\n(You close your eyes...)\n");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Can I open them now?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Holy Cat: Sure.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Okay...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Huh???");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I'm back!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Thanks Holy Cat!");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("???: Huh?");
        ...
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I know those voices...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Moon? Sun?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Moon: Is that really you, " + mainName + "?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Sun: " + mainName + "?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I'm home! Where were you guys?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Moon: We went to go buy some spices and herbs.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Sun: Yeah, we always do that...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Oh...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I thought you guys were lost...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": I climbed a whole mountain to look for you guys...");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Moon: Wow.");
        TimeUnit.SECONDS.sleep(2);
        System.out.println("Sun: That's cool? Did you find anything?");
        TimeUnit.SECONDS.sleep(2);
        System.out.println(mainName + ": Yeah, I found a necklace!");
        TimeUnit.SECONDS.sleep(2);
